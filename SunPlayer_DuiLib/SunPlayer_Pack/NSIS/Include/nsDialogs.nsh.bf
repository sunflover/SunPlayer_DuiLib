...
!macro __NSD_SetIcon CONTROL ICON HANDLE
	...
	System::Call 'user32::LoadImage(i0, ts, i ${IMAGE_ICON}, i0, i0, i${LR_LOADFROMFILE}) i.s' "${ICON}"
	Pop $0
    SendMessage $R0 ${STM_SETIMAGE} ${IMAGE_ICON} $0
...
!define NSD_SetIcon `!insertmacro __NSD_SetIcon`

!macro __NSD_SetStretchedIcon CONTROL ICON HANDLE
	...
	System::Call 'user32::LoadImage(i0, ts, i ${IMAGE_ICON}, ir1, ir2, i${LR_LOADFROMFILE}) i.s' "${ICON}"
	Pop $0
    SendMessage $R0 ${STM_SETIMAGE} ${IMAGE_ICON} $0
