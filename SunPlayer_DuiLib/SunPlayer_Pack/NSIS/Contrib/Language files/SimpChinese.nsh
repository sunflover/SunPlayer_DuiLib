...
!ifdef MUI_COMPONENTSPAGE
  ...
  ${LangFileString} MUI_TEXT_COMPONENTS_SUBTITLE "选择你想要安装“$(^NameDA)”的功能组件。"
  ${LangFileString} MUI_INNERTEXT_COMPONENTS_DESCRIPTION_TITLE "描述"
!endif

!ifdef MUI_UNCOMPONENTSPAGE
  ${LangFileString} MUI_UNTEXT_COMPONENTS_TITLE "选定组件"
  ${LangFileString} MUI_UNTEXT_COMPONENTS_SUBTITLE "选定“$(^NameDA)”中你想要卸载的功能。"
!endif
...
!ifdef MUI_FINISHPAGE
  ${LangFileString} MUI_TEXT_FINISH_INFO_TITLE "$(^NameDA) 已经完成安装"
...
!ifdef MUI_UNFINISHPAGE
  ${LangFileString} MUI_UNTEXT_FINISH_INFO_TITLE "$(^NameDA)已经卸载"
